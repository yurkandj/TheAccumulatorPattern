...
def run_test_count_cosines_from():
    ...
    # ------------------------------------------------------------------
    expected = 1
    answer = count_cosines_from(4, 11, 0.9)
    print('Test 2 expected:', expected)
    print('       actual:  ', answer)

    expected = 5
    answer = count_cosines_from(3, 17, 0.2)
    print('Test 3 expected:', expected)
    print('       actual:  ', answer)

    expected = 12
    answer = count_cosines_from(6, 40, 0.45)
    print('Test 4 expected:', expected)
    print('       actual:  ', answer)

    expected = 27
    answer = count_cosines_from(4, 71, 0.31)
    print('Test 5 expected:', expected)
    print('       actual:  ', answer)

    expected = 3
    answer = count_cosines_from(9, 18, 0.39)
...
def run_test_sum_unit_fractions_from():
    ...
    # ------------------------------------------------------------------
    expected = 0.730133  # This is APPROXIMATELY the correct answer.
    answer = sum_unit_fractions_from(7, 13)
    print('Test 1 expected:', expected, '(approximately)')
    print('       actual:  ', answer)

    expected = 2.928968  # This is APPROXIMATELY the correct answer.
